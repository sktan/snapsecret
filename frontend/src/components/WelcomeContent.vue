...
<template>
    ...
    <WelcomeItem>
        ...
        You will first need to submit your secret via the
        <router-link :to="{ name: 'secret.new' }">New Secret</router-link> page.
    ...
    <WelcomeItem>
        <template #heading>Sending the OTA link</template>
